package com.bolivar.comunes.personas_trabajadores_arl.consultarguardiantrabajador.repository;
...
public interface PrcTrabajadoresArlGuardianRepository {
    ...
    @Select(value = "{call SIM_PCK_EXTRAC_INFOGUARDIAN.prc_trabajadores_arl_guardian(\n" +
            ...
            "   #{procConsultasTrabajadorParams.poTrabajadores        , jdbcType = ARRAY   , jdbcTypeName = SIM_ARRAY_ARL_TRABAJADORES, typeHandler = com.bolivar.comunes.personas_trabajadores_arl.commons.handlers.SimTypArlTrabajadorHandler, mode = OUT},\n" +
            ...
            "   #{procConsultasTrabajadorParams.ipProceso             , jdbcType = STRUCT  , jdbcTypeName = SIM_TYP_PROCESO         , typeHandler = com.bolivar.mybatis.util.core.handler.InputTypeHandler, mode = IN},\n" +
            "   #{procConsultasTrabajadorParams.opResultado           , jdbcType = NUMERIC , mode = OUT                             },\n" +
            "   #{procConsultasTrabajadorParams.opArrErrores          , jdbcType = ARRAY   , jdbcTypeName = SIM_TYP_ARRAY_ERROR, typeHandler = com.bolivar.comunes.personas_trabajadores_arl.commons.handlers.SimTypArrayErrorHandler, mode = OUT}\n" +
            "   )}"
    )
