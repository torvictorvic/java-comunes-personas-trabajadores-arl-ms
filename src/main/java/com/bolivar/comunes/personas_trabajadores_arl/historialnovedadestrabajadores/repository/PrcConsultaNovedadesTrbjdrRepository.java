package com.bolivar.comunes.personas_trabajadores_arl.historialnovedadestrabajadores.repository;
...
public interface PrcConsultaNovedadesTrbjdrRepository {
    ...
    @Select(value = "{call ARL_PCK_TRABAJADORES.PRC_CONSULTA_NOVEDADES_TRBJDR("
            + "#{parametros.ipHistoriconovedades, jdbcType = ARRAY, jdbcTypeName = SIM_TYP_ARRAY_LISTA, typeHandler = com.bolivar.mybatis.util.core.handler.InputListHandler, mode = IN},\n"
            + "#{parametros.opHistoriconovedades, jdbcType = ARRAY, jdbcTypeName = ARL_TYP_TBL_HIST_NOVS_SALIDA, typeHandler =com.bolivar.comunes.personas_trabajadores_arl.commons.handlers.ArlTypTblHistNovsSalidaHandler, mode = OUT},\n"
