package com.xxxxxxxx.comunes.personas_trabajadores_arl.consultarcargotrabajador.repository;
...
public interface PrcProcListaCargoRepository {
    @Select(value = "{call ARL_PCK_LISTAS.Proc_Listacargo("
            ...
            + "#{parametros.opArrLista, jdbcType = ARRAY, jdbcTypeName = SIM_TYP_ARRAY_LISTA, typeHandler = com.xxxxxxxx.comunes.personas_trabajadores_arl.commons.handlers.SimTypArrayListaHandler, mode = OUT},\n"
