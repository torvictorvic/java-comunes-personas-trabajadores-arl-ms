...
public interface PrcProcConsultaTrabajadoresOrdnRepository {
	@Select(value = "{call ARL_PCK_CONSULTA_TRAB_PAG_OPT.Proc_Consultatrabajadores_Ordn("
			...
			+ "#{parametros.opArraydatostrabajadores, jdbcType = ARRAY, jdbcTypeName = ARL_TYP_ARRAY_CONSTRBJADORS_CT, typeHandler = com.xxxxxxxx.comunes.personas_trabajadores_arl.commons.handlers.ArlTypArrayConstrbjadorsCtHandler, mode = OUT},\n"
